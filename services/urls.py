...
from .views import PayServicesView, ServicesView,ServiceView, TagView, TaxiServiceDetailView, TaxiServiceView
...
urlpatterns = [
    ...
    path('service/pay', PayServicesView.as_view(), name='pay-service-list'),
]